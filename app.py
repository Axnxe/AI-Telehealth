...
st.markdown("""
# 🏥 Obas Lab Clinical Operations Dashboard
### AI-Assisted SOAP Workflow System (Prototype)

---
**Status:** 🟢 Live Session Active  
**Patient Safety:** Synthetic Data Only (No PHI Stored)  
**System:** Streamlit + Groq LLM
---
""")
...
with tab1:
    ...
    with col1:
        st.markdown("### Subjective / Objective")
        st.text_area(
            "",
    ...
    if st.button("📥 Export SOAP as PDF"):
        export_pdf(st.session_state.soap)
        st.success("PDF generated successfully")

    st.markdown("## 🕒 Encounter Timeline")
    st.write("🟢 Patient selected")
    st.write("🟡 Clinical notes entered")
    st.write("🔵 SOAP generated by AI")
    st.write("⚪ Pending clinician review")
